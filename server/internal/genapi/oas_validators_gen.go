...
func (s *BlockWrite) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s BlockWriteKind) Validate() error {
	switch s {
	case "paragraph":
		return nil
	case "heading":
...
func (s FleetModelLiveState) Validate() error {
	switch s {
	case "up":
		return nil
	case "down":
...
func (s *FleetState) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s FleetStateControl) Validate() error {
	switch s {
	case "up":
		return nil
	case "unreachable":
